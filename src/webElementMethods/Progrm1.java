...
System.setProperty("webdriver.chrome.driver", "D:\\Velocity\\Java Class\\Dec-2021 Class\\4thDecEvening\\chromedriver.exe");
		...
		Thread.sleep(1000);
		//validating button status after entering valid mobile number
		boolean ButtonStatus1 = getOTPButton.isEnabled();
		
		//printing status
		System.out.println("Get OTP button status is "+ButtonStatus1);
